...
const SHIFT_DISTANCE = 400; //400
const CONTAINER_ORIGIN = -20; //-20
const EASING = 0.05;
...
const PhotoQueue = () => {
  ...
  useEffect(() => {
    ...
    const mouseHandler = (e: MouseEvent) => {
      nextMouseShiftY = (e.clientY / innerHeight) * 5 - 5;
      nextMouseShiftX = (e.clientX / innerHeight) * 5 - 5;
    };
